...
<head>
    ...
    <title>Something went wrong — AceBank</title>
...
<div class="stage">
  <div class="stage-card">
    <div class="stage-code">500</div>
    <h1>Something went wrong</h1>
    <p>An unexpected error occurred on our end. Please try again in a moment.</p>
    <a class="btn btn-blue btn-lg" href="${pageContext.request.contextPath}/index.jsp">Back to home</a>
  </div>
</div>
</body>
</html>
